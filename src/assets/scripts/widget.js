  ...
  (/MSIE ([6789]|10)/.test(navigator.userAgent) ||
    ...
    (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
      (function (t) {
              ...
              (u.charset = "utf-8"),
                ...
                (u.src = (function (t) {
                  return (
                    ...
                    "." +
                    {
                      0: "ef2fecba8465ec0ef7967553ca4bee54",
                      2: "8c70c61a81ad24b790b1ab140a629ed6",
                      3: "dd024c345fc26f7c7a8d9938b67e5d3d",
                      4: "f261877d67dc45f3972d303d6b32c138",
                      5: "2db7ad7d46482c02e98f067d7630f7f1",
            ...
            splitLogEntry: function (t) {
              ...
              return t.item_ids && t.item_ids.length > 1
                ? ((e = Math.floor(t.item_ids.length / 2)),
                  ...
                  [s.aug({}, t, { item_ids: n, item_details: r }), s.aug({}, t, { item_ids: i, item_details: o })])
                : [t];
            },
            ...
            a = new (n(109))(function (t) {
              ...
              if (0 !== t.length) {
                ...
                (e = r(t, function (t) {
                  ...
                  (n = e.true),
                  (a = e.false),
                  n && n.length > 0 && ((n = n.slice(0, 1)), o.canFlushOneItem(n[0]) || (n[0].input.data.message = ""), c(n)),
                  a &&
                    (u(a)
                      ? c
                      : function (t) {
        ...
        function (t) {
          t.exports = { version: "3a9d480:1557901433737" };
        },
        function (t, e, n) {
          var r,
            i = n(10),
        ...
        function (t) {
          t.exports = {
            tweetButtonHtmlPath: "/widgets/tweet_button.fb066ff7f5f4afee7716887031da2ea8.{{lang}}.html",
            followButtonHtmlPath: "/widgets/follow_button.fb066ff7f5f4afee7716887031da2ea8.{{lang}}.html",
            hubHtmlPath: "/widgets/hub.html",
            widgetIframeHtmlPath: "/widgets/widget_iframe.fb066ff7f5f4afee7716887031da2ea8.html",
        ...
        function (t, e, n) {
          ...
          (s.prototype.add = function (t) {
            var e = new r();
            return this._inputsQueue.push({ input: t, taskDoneDeferred: e }), this._hasFlushBeenScheduled || ((this._hasFlushBeenScheduled = !0), i(o(this._flush, this))), e.promise;
          }),
                ...
                t
                  .reduce(function (e, n, r) {
                    var i = e.length,
                      o = i && e[i - 1];
                    return (
                      r + 1 == t.length && n.event_namespace && "batch_log" == n.event_namespace.action && (n.message = ["entries:" + r, "requests:" + i].join("/")),
                      (function t(e) {
                        return (
                          Array.isArray(e) || (e = [e]),
                        ...
                        var n = g(t);
                        (!o || o.urlLength + n > c) && ((o = { urlLength: l, items: [] }), e.push(o)), (o.urlLength += n), o.items.push(t);
                      }),
                      e
                    );
                  }, [])
        ...
        function (t, e, n) {
          ...
          t.exports = function (t) {
            var e, n;
            return (e = t.headers && t.headers.status), !(n = t && !t.error && 200 === e) && t.headers && t.headers.message && r.publicError(t.headers.message), { success: n, resp: t };
          };
        },
        function (t, e, n) {
          var r,
          ...
          function u(t) {
            ...
            t.altKey ||
              ...
              ((e = o.closest(function (t) {
                ...
                ((n = (n = (n = [(u = e.href), "original_referer=" + r.href].join(-1 == u.indexOf("?") ? "?" : "&")).replace(/^http[:]/, "https:")).replace(/^\/\//, "https://")), s.open(n, e), i.preventDefault(t)));
          }
          t.exports = {
            attachTo: function (t) {
        ...
        function (t, e, n) {
          ...
          t.exports = {
            load: function () {
              ...
              (t = { origin: f.origin, settingsEndpoint: u.settings() }),
              ...
              return (
                ...
                b()
                  .promise.then(function () {
                    e && e.name && e.assignment && (((n = {})[e.name] = { bucket: e.assignment }), (r.experiments = w.aug(r.experiments, n))), t.resolve(r);
                  })
                  .catch(function (e) {
                    t.reject(e);
                  }),
        ...
        function (t, e, n) {
          var r = n(17),
            ...
            l = { position: "static", visibility: "visible" },
            h = {};
          i(function (t, e, n) {
            var r = h[t];
            if (r)
        ...
        function (t, e, n) {
          ...
          function p(t) {
            ...
            return a.isString(t) || a.isNumber(t)
              ? f.reject("Embedded timelines with widget settings have been deprecated. See https://twittercommunity.com/t/deprecating-widget-settings/102295.")
              : s.isObject(t)
              ? ((t = t || {}),
                n.forEach(function (t) {
                  s.isType("object", t) &&

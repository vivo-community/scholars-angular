!(function (e) {
    ...
    if (!window.__dimensions_embed) {
      var a = function () {
        ...
        c = function () {
          ...
          if (e.length)
            for (var n = 0; n < e.length; ++n)
              !(function (n) {
                var t = new o.a(e[n].attributes, window.__dimensions_detail_url, window.__dimensions_metrics_api, window.__dimensions_badge_server);
                new r.a(t.metricsURL).fetch(function (i) {
        ...
        d = function () {
          ...
          (e.rel = "stylesheet"), (e.href = window.__dimensions_badge_url + "/badge.css"), document.getElementsByTagName("head")[0].appendChild(e);
        },
        l = function () {
        ...
        function e(n, t, s) {
          ...
          i(this, e),
            Object.defineProperty(this, "onMouseOver", {
              ...
              writable: !0,
              value: function () {
                if (((o.badgeComponent.className = "__dimensions_Badge __dimensions_Badge_style_" + o.config.badgeType + " __dimensions_Badge_hover"), o.legendComponent))
                  switch (o.config.legendDisplay) {
                    case "always":
                    case "never":
                      return;
                    case "hover-top":
                    ...
                    case "hover-bottom":
                    case "hover-left":
                      o.legendComponent.className = "__dimensions_Badge_Legend_padding __dimensions_Badge_Legend_hover __dimensions_Badge_Legend_" + o.config.legendDisplay + "  __dimensions_Badge_Legend_style_" + o.config.badgeType;
                      break;
                    case "hover-auto":
                      o.legendComponent.className = "__dimensions_Badge_Legend_padding __dimensions_Badge_Legend_hover __dimensions_Badge_Legend_hover-" + o.optimalHoverDirection + "  __dimensions_Badge_Legend_style_" + o.config.badgeType;
                  }
              },
            }),
            Object.defineProperty(this, "onMouseOut", {
              ...
              writable: !0,
              value: function () {
                if (((o.badgeComponent.className = "__dimensions_Badge __dimensions_Badge_style_" + o.config.badgeType), o.legendComponent))
                  switch (o.config.legendDisplay) {
                    case "always":
                    case "never":
                      return;
                    default:
                      o.legendComponent.className = "__dimensions_Badge_Legend_padding  __dimensions_Badge_Legend_style_" + o.config.badgeType;
                  }
              },
            }),
            Object.defineProperty(this, "trigger", {
              ...
              value: function (e) {
                window.setTimeout(function () {
                  ...
                  n.initEvent(e, !0, !0), o.component.dispatchEvent(n);
                });
              },
            }),
            (this.component = n),
        ...
        return (
          d(e, [
            ...
            },
            {
              key: "installElements",
              value: function () {
                this.badgeComponent && this.wrapperComponent.appendChild(this.badgeComponent), this.legendComponent && this.wrapperComponent.appendChild(this.legendComponent), this.component.appendChild(this.wrapperComponent), this.component.setAttribute("data-dimensions-badge-installed", !0);
              },
            },
            {
              key: "buildWrapper",
              value: function () {
                ...
                return (
                  ...
                  window.addEventListener("touchstart", function () {
                    n.removeEventListener("mouseover", e.onMouseOver), n.removeEventListener("mouseout", e.onMouseOut);
                  }),
                  n
                );
              },
            ...
            },
            {
              ...
              value: function () {
                if (!this.legendHidden) {
                  ...
                  (e.className = "__dimensions_Badge_Legend_padding __dimensions_Badge_Legend_hover-right  __dimensions_Badge_Legend_style_" + this.config.badgeType), this.legendAlwaysVisible && (e.className += " __dimensions_Badge_Legend_always");
  ...
  function (e, n, t) {
    ...
    var s = t(8),
      ...
      r = ["never", "always", "hover-auto", "hover-top", "hover-right", "hover-bottom", "hover-left"],
      ...
      c = (function () {
        function e() {
          var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
            ...
            s = arguments[2],
            o = arguments[3];
          i(this, e), (this.detailPageHost = t), (this.dimensionsMetricsApi = s), (this.badgeServerURL = o), (this.legendDisplay = "hover-auto"), (this.badgeType = "medium_circle");
          for (var c = 0; c < n.length; c++) {
            ...
            switch (d.name) {
              ...
              case "data-hide-zero-citations":
                ...
                break;
              case "data-legend":
                r.indexOf(d.value) >= 0 && (this.legendDisplay = d.value);
                break;
              case "data-style":
    ...
    var r = function e(n) {
      ...
      a = (function (e) {
        function n() {
          ...
          return (
            (t = s = i(this, (e = n.__proto__ || Object.getPrototypeOf(n)).call.apply(e, [this].concat(c)))),
  ...
  function (e, n, t) {
    ...
    var s = t(10),
      ...
      a = (function () {
        function e(n) {
          i(this, e), (this.url = n), (this.exists = void 0), (this.timesCited = null), (this.recentCitations = null), (this.highlyCited1 = null), (this.highlyCited5 = null), (this.highlyCited10 = null), (this.rcr = null), (this.fcr = null);
        }
        return (
          r(e, [
            {
              ...
              value: function (e) {
                var n = this;
                o.a.get(this.url, { useXDR: !0 }, function (t, i, s) {
                  if (i.statusCode < 200 || i.statusCode >= 300) n.exists = !1;
                  else {
                    var o = JSON.parse(s);
                    (n.exists = !0), (n.timesCited = o.times_cited), (n.recentCitations = o.recent_citations), (n.highlyCited1 = o.highly_cited_1), (n.highlyCited5 = o.highly_cited_5), (n.highlyCited10 = o.highly_cited_10), (n.rcr = o.relative_citation_ratio), (n.fcr = o.field_citation_ratio);
                  }
                  e(n);
                });
              },
  ...
  function (e, n, t) {
    ...
    function r(e) {
      ...
      function s(e) {
        return clearTimeout(h), e instanceof Error || (e = new Error("" + (e || "Unknown XMLHttpRequest Error"))), (e.statusCode = 0), d(e, w);
      }
      function r() {
        if (!f) {
          var n;
          clearTimeout(h), (n = e.useXDR && void 0 === l.status ? 200 : 1223 === l.status ? 204 : l.status);
          var i = w,
            s = null;
          return (
            0 !== n
              ? ((i = {
                ...
                l.getAllResponseHeaders && (i.headers = u(l.getAllResponseHeaders())))
      ...
      if (
        ("json" in e && !1 !== e.json && ((y = !0), v.accept || v.Accept || (v.Accept = "application/json"), "GET" !== g && "HEAD" !== g && (v["content-type"] || v["Content-Type"] || (v["Content-Type"] = "application/json"), (m = JSON.stringify(!0 === e.json ? m : e.json)))),
    ...
    var d = t(11),
      ...
      _ = t(16);
    (e.exports = o),
      (o.XMLHttpRequest = d.XMLHttpRequest || c),
      (o.XDomainRequest = "withCredentials" in new o.XMLHttpRequest() ? o.XMLHttpRequest : d.XDomainRequest),
      (function (e, n) {
        for (var t = 0; t < e.length; t++) n(e[t]);
      })(["get", "put", "post", "patch", "head", "delete"], function (e) {
        o["delete" === e ? "del" : e] = function (n, t, i) {
          return (t = s(n, t, i)), (t.method = e.toUpperCase()), r(t);
        };
      });
  },
  function (e, n, t) {
  ...
  function (e, n, t) {
    ...
    e.exports = function (e) {
      ...
      return (
        s(i(e).split("\n"), function (e) {
          var t = e.indexOf(":"),
            s = i(e.slice(0, t)).toLowerCase(),
            r = i(e.slice(t + 1));
          void 0 === n[s] ? (n[s] = r) : o(n[s]) ? n[s].push(r) : (n[s] = [n[s], r]);
        }),
        n
      );
    };
  ...
  function (e, n, t) {
    function i(e, n, t) {
      if (!a(n)) throw new TypeError("iterator must be a function");
      arguments.length < 3 && (t = this), "[object Array]" === c.call(e) ? s(e, n, t) : "string" == typeof e ? o(e, n, t) : r(e, n, t);
    }
    function s(e, n, t) {
      for (var i = 0, s = e.length; i < s; i++) d.call(e, i) && n.call(t, e[i], i, e);
    }
    function o(e, n, t) {
      for (var i = 0, s = e.length; i < s; i++) n.call(t, e.charAt(i), i, e);
    }
    function r(e, n, t) {
      for (var i in e) d.call(e, i) && n.call(t, e[i], i, e);
    }
    var a = t(0);
    e.exports = i;
